...
//   aud?: string,
//   iss?: string
// ): Promise<{ id: string; payload: Payload; expires_at: Date , issued_at: Date }> {
//   const secretKey = new TextEncoder().encode(secret);
...
//       issued_at: new Date((iat as number) * 1000),
//     };
//   } catch (error) {
...
// ): Promise<boolean> {
//   try {
//     await decode_jwt(secret, token, aud, iss);
//     return true;
//   } catch (error) {
